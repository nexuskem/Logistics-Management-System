        ...
        <div className="p-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label htmlFor="name" className="block text-xs font-bold text-brand-muted uppercase tracking-wider">
                Full Name
              </label>
              <input
                id="name"
            ...
            <div className="space-y-1.5">
              <label htmlFor="password" className="block text-xs font-bold text-brand-muted uppercase tracking-wider">
                Password
              </label>
              <input
                id="password"
